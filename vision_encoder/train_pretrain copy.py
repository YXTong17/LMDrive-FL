...
def main():
    ...
    if "carla" in args.dataset:
        ...
        args_data = Namespace(cfg_path='/home/tyx/yjl/LMDrive/LAVIS/lavis/projects/lmdrive/notice_llava15_visual_encoder_r50_seq40.yaml', options=None)
